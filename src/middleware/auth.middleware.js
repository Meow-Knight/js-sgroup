...
var authRequired = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                savedSession = req.signedCookies.savedSession;
                if (!savedSession) {
                    return [2 /*return*/, res.redirect('auth/login')];
                }
                return [4 /*yield*/, session_1["default"].findById(savedSession.sessionId)];
            case 1:
                session = _a.sent();
...
var authNotRequired = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    var savedSession;
    return __generator(this, function (_a) {
        savedSession = req.signedCookies.savedSession;
        if (savedSession) {
